...
<head>
    ...
    <link href="{{asset('assets/css/customer/customer-panel-stype.css')}}" rel="stylesheet">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-md-end">
                        <div class="ml-3">
                            <select name="countries" class="custome_select">
                                <option value='GBR' data-title="BDT">BDT</option>
                            </select>
                        </div>
                    </div>
                </div>--}}
...
@include('customer.layout.modal-busy')
